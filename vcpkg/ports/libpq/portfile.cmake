vcpkg_download_distfile(
  ...
  SHA512
  fdbe6d726f46738cf14acab96e5c05f7d65aefe78563281b416bb14a27c7c42e4df921e26b32816a5030ddbe506b95767e2c74a35afc589916504df38d1cb11c
)
...
if ("client" IN_LIST FEATURES)
  ...
  if (VCPKG_CROSSCOMPILING)
    list(
      APPEND
      MESON_OPTIONS
      "-DZIC=${CURRENT_HOST_INSTALLED_DIR}/manual-tools/${PORT}/zic${VCPKG_HOST_EXECUTABLE_SUFFIX}"
    )
  endif ()
endif ()
...
if ("client" IN_LIST FEATURES)
  if (NOT VCPKG_CROSSCOMPILING)
    vcpkg_copy_tools(
      ...
      AUTO_CLEAN
      DESTINATION
      "${CURRENT_PACKAGES_DIR}/manual-tools/${PORT}"
    )
  endif ()
  vcpkg_copy_tools(
    TOOL_NAMES
