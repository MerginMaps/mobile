...
if (PostgreSQL_FOUND AND "@VCPKG_LIBRARY_LINKAGE@" STREQUAL "static")
  ...
  foreach (LIB_ITEM pgport pgcommon)
    find_library(
      PostgreSQL_${LIB_ITEM}_LIBRARY_RELEASE
      NAMES ${LIB_ITEM} lib${LIB_ITEM} NAMES_PER_DIR
      PATHS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/lib"
      NO_DEFAULT_PATH
    )
    if (TARGET PostgreSQL::PostgreSQL AND PostgreSQL_${LIB_ITEM}_LIBRARY_RELEASE)
      set_property(
        ...
        PROPERTY INTERFACE_LINK_LIBRARIES
                 "\$<\$<NOT:\$<CONFIG:DEBUG>>:${PostgreSQL_${LIB_ITEM}_LIBRARY_RELEASE}>"
      )
    endif ()

    find_library(
      PostgreSQL_${LIB_ITEM}_LIBRARY_DEBUG
      NAMES ${LIB_ITEM} lib${LIB_ITEM} NAMES_PER_DIR
      PATHS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/debug/lib"
      NO_DEFAULT_PATH
    )
    if (TARGET PostgreSQL::PostgreSQL AND PostgreSQL_${LIB_ITEM}_LIBRARY_DEBUG)
      set_property(
        ...
        APPEND
        PROPERTY INTERFACE_LINK_LIBRARIES
                 "\$<\$<CONFIG:DEBUG>:${PostgreSQL_${LIB_ITEM}_LIBRARY_DEBUG}>"
      )
    endif ()
  ...
  if (WIN32)
    if (TARGET PostgreSQL::PostgreSQL)
      set_property(
        TARGET PostgreSQL::PostgreSQL
        APPEND
        PROPERTY INTERFACE_LINK_LIBRARIES "secur32.lib"
      )
    endif ()
  ...
  if (WIN32)
    if (TARGET PostgreSQL::PostgreSQL)
      set_property(
        TARGET PostgreSQL::PostgreSQL
        APPEND
        PROPERTY INTERFACE_LINK_LIBRARIES "wldap32.lib"
      )
    endif ()
