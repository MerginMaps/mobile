...
vcpkg_check_features(
  ...
  "widgets"
  CMAKE_REQUIRE_FIND_PACKAGE_Qt6Widgets
  INVERTED_FEATURES
  "qml"
  CMAKE_DISABLE_FIND_PACKAGE_Qt6Quick
  "widgets"
  CMAKE_DISABLE_FIND_PACKAGE_Qt6Widgets
  "gstreamer"
  ...
  "vaapi"
  CMAKE_DISABLE_FIND_PACKAGE_VAAPI # not in vpckg
)
...
if (NOT
    ...
    AND NOT
        ...
        IN_LIST
        FEATURES
    AND VCPKG_TARGET_IS_LINUX
)
  # list(APPEND FEATURE_OPTIONS "-DFEATURE_alsa=ON") # alsa is experimental so don't
...
if ("gstreamer" IN_LIST FEATURES AND VCPKG_LIBRARY_LINKAGE STREQUAL "static")
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/share/Qt6Multimedia/Qt6QGstreamerMediaPluginDependencies.cmake"
    "GStreamer\;FALSE\;\;\;;GStreamer\;FALSE\;\;App\;;GStreamer\;FALSE\;\;\;Gl"
    "GStreamer\;FALSE\;\;\;;GStreamer\;FALSE\;\;App\;;GStreamer\;FALSE\;\;\;Gl;EGL\;FALSE\;\;\;"
    IGNORE_UNCHANGED
  )
endif ()
