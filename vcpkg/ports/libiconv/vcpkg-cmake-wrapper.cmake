...
if (APPLE
    ...
    AND EXISTS "${CMAKE_OSX_SYSROOT}/usr/include/iconv.h"
)
  set(Z_VCPKG_ICONV_USES_DARWIN_SDK TRUE)
  set(Iconv_IS_BUILT_IN
      FALSE
      CACHE BOOL "iconv requires a separate library"
  )
  if (NOT Iconv_INCLUDE_DIR)
    set(Iconv_INCLUDE_DIR
        "${CMAKE_OSX_SYSROOT}/usr/include"
        CACHE PATH "iconv include directory"
    )
  endif ()
  if (NOT Iconv_LIBRARY)
    set(Iconv_LIBRARY
        iconv
        CACHE STRING "iconv library"
    )
  endif ()
endif ()
...
_find_package(${ARGS})
if (Iconv_FOUND
    AND NOT Iconv_IS_BUILT_IN
    AND NOT Z_VCPKG_ICONV_USES_DARWIN_SDK
)
  find_path(
    CHARSET_INCLUDE_DIR
    NAMES "libcharset.h"
