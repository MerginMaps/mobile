...
if (VCPKG_TARGET_IS_ANDROID AND NOT ANDROID_SDK_ROOT)
  message(
    FATAL_ERROR
      "${PORT} requires ANDROID_SDK_ROOT to be set. Consider adding it to the triplet."
  )
endif ()
...
function (qt_download_submodule_impl)
  ...
  if ("${_qarg_SUBMODULE}" IN_LIST QT_FROM_QT_GIT)
    ...
    vcpkg_from_git(
      ...
      SOURCE_PATH
      URL
      "https://code.qt.io/qt/${_qarg_SUBMODULE}.git"
      REF
...
function (qt_cmake_configure)
  ...
  set(Z_VCPKG_CMAKE_GENERATOR
      "${Z_VCPKG_CMAKE_GENERATOR}"
      PARENT_SCOPE
  )
endfunction ()
