# Reminder for myself and everybody else: Qt cross module dependency information within
# the Qt respository is wrong and/or incomplete. Always check the toplevel CMakeLists.txt
# for the find_package call and search for linkage against the Qt:: targets Often enough
# certain (bigger) dependencies are only used to build examples and/or tests. As such
# getting the correct dependency information relevant for vcpkg requires a manual
# search/check
set(QT_IS_LATEST ON)
...
if (VCPKG_TARGET_IS_LINUX)
  message(
    WARNING
      "qtbase currently requires packages from the system package manager. "
...
# Features can be found via searching for qt_feature in all configure.cmake files in the
# source: The files also contain information about the Platform for which it is searched
# Always use FEATURE_<feature> in vcpkg_cmake_configure (using QT_FEATURE_X overrides Qts
# condition check for the feature.) Theoretically there is a feature for every widget to
# enable/disable it but that is way to much for vcpkg
...
foreach (_input IN LISTS input_vars)
  ...
  elseif (_input STREQUAL "libmd4c")
    string(APPEND INPUT_OPTIONS qt) # libmd4c is not yet in VCPKG (but required by
                                    # qtdeclarative)
  else ()
...
vcpkg_check_features(
  ...
  "dbus"
  CMAKE_DISABLE_FIND_PACKAGE_WrapDBus1
)
...
vcpkg_check_features(
  ...
  "glib"
  CMAKE_REQUIRE_FIND_PACKAGE_GLIB2
  INVERTED_FEATURES
  # "doubleconversion"      CMAKE_DISABLE_FIND_PACKAGE_WrapDoubleConversion # Required
  # "pcre2"                 CMAKE_DISABLE_FIND_PACKAGE_WrapSystemPCRE2 # Bug in qt cannot
  # be deactivated
  "icu"
  CMAKE_DISABLE_FIND_PACKAGE_ICU
  "glib"
  CMAKE_DISABLE_FIND_PACKAGE_GLIB2
)
...
# Cannot be disabled on x64 platforms list(APPEND FEATURE_CORE_OPTIONS
# -DCMAKE_DISABLE_FIND_PACKAGE_WrapRt:BOOL=ON) # Cannot be disabled on osx
...
vcpkg_check_features(
  ...
  FEATURE_brotli
  "securetransport"
  FEATURE_securetransport
  "dnslookup"
  FEATURE_dnslookup
  # "brotli"              CMAKE_REQUIRE_FIND_PACKAGE_WrapBrotli "openssl"
  # CMAKE_REQUIRE_FIND_PACKAGE_WrapOpenSSL
  INVERTED_FEATURES
  "brotli"
  CMAKE_DISABLE_FIND_PACKAGE_WrapBrotli
  "openssl"
  CMAKE_DISABLE_FIND_PACKAGE_WrapOpenSSL
  "dnslookup"
...
vcpkg_check_features(
  ...
  FEATURES
  "freetype"
  FEATURE_freetype # required on windows
  "harfbuzz"
  FEATURE_harfbuzz
  "fontconfig"
  FEATURE_fontconfig # NOT WINDOWS
  "jpeg"
  FEATURE_jpeg
  "png"
  FEATURE_png
  ...
  FEATURE_xcb_xlib
  "xkbcommon-x11"
  FEATURE_xkbcommon_x11
  "xrender"
  FEATURE_xrender # requires FEATURE_xcb_native_painting; otherwise disabled.
  "xrender"
  FEATURE_xcb_native_painting # experimental
  "gles2"
  FEATURE_opengles2
  "gles3"
  FEATURE_opengles3
  # Cannot be required since Qt will look in CONFIG mode first but is controlled via
  # CMAKE_DISABLE_FIND_PACKAGE_Vulkan below "vulkan"
  # CMAKE_REQUIRE_FIND_PACKAGE_WrapVulkanHeaders
  "egl"
  FEATURE_egl
  # "fontconfig"          CMAKE_REQUIRE_FIND_PACKAGE_Fontconfig "harfbuzz"
  # CMAKE_REQUIRE_FIND_PACKAGE_WrapSystemHarfbuzz "jpeg" CMAKE_REQUIRE_FIND_PACKAGE_JPEG
  # "png"                 CMAKE_REQUIRE_FIND_PACKAGE_PNG "xlib"
  # CMAKE_REQUIRE_FIND_PACKAGE_X11 "xkb" CMAKE_REQUIRE_FIND_PACKAGE_XKB "xcb"
  # CMAKE_REQUIRE_FIND_PACKAGE_XCB "xcb-xlib" CMAKE_REQUIRE_FIND_PACKAGE_X11_XCB
  # "xkbcommon-x11" CMAKE_REQUIRE_FIND_PACKAGE_XKB_COMMON_X11 "xrender"
  # CMAKE_REQUIRE_FIND_PACKAGE_XRender
  INVERTED_FEATURES
  "vulkan"
  CMAKE_DISABLE_FIND_PACKAGE_Vulkan
  "opengl"
  CMAKE_DISABLE_FIND_PACKAGE_WrapOpenGL
  "egl"
  CMAKE_DISABLE_FIND_PACKAGE_EGL
  "gles2"
  CMAKE_DISABLE_FIND_PACKAGE_GLESv2
  "gles3"
  CMAKE_DISABLE_FIND_PACKAGE_GLESv3
  "fontconfig"
  CMAKE_DISABLE_FIND_PACKAGE_Fontconfig
  # "freetype"            CMAKE_DISABLE_FIND_PACKAGE_WrapSystemFreetype # Bug in qt cannot
  # be deactivated
  "harfbuzz"
  CMAKE_DISABLE_FIND_PACKAGE_WrapSystemHarfbuzz
  "jpeg"
  CMAKE_DISABLE_FIND_PACKAGE_JPEG
  # "png"                 CMAKE_DISABLE_FIND_PACKAGE_PNG # Unable to disable if Freetype
  # requires it
  "xlib"
  ...
  "xcb-xlib"
  CMAKE_DISABLE_FIND_PACKAGE_X11_XCB
  "xkbcommon-x11"
  CMAKE_DISABLE_FIND_PACKAGE_XKB_COMMON_X11
  "xrender"
  CMAKE_DISABLE_FIND_PACKAGE_XRender
  # There are more X features but I am unsure how to safely disable them! Most of them
  # seem to be found automaticall with find_package(X11)
)
...
vcpkg_check_features(
  ...
  "sql-oci"
  FEATURE_sql_oci
  # "sql-psql"            CMAKE_REQUIRE_FIND_PACKAGE_PostgreSQL "sql-sqlite"
  # CMAKE_REQUIRE_FIND_PACKAGE_SQLite3
  INVERTED_FEATURES
  "sql-psql"
  CMAKE_DISABLE_FIND_PACKAGE_PostgreSQL
  "sql-sqlite"
  CMAKE_DISABLE_FIND_PACKAGE_SQLite3
  "sql-odbc"
  CMAKE_DISABLE_FIND_PACKAGE_ODBC
  "sql-mysql"
  CMAKE_DISABLE_FIND_PACKAGE_MySQL
  "sql-oci"
  CMAKE_DISABLE_FIND_PACKAGE_Oracle
)
...
vcpkg_check_features(
  ...
  INVERTED_FEATURES
  "cups"
  CMAKE_DISABLE_FIND_PACKAGE_Cups
)
...
vcpkg_check_features(
  ...
  INVERTED_FEATURES
  "gtk3"
  CMAKE_DISABLE_FIND_PACKAGE_GTK3
)
...
file(COPY "${CMAKE_CURRENT_LIST_DIR}/cmake/"
...
file(
  CONFIGURE
  OUTPUT
  "${CURRENT_PACKAGES_DIR}/share/${PORT}/port_status.cmake"
  CONTENT
  "set(qtbase_with_icu ${FEATURE_icu})\n"
)
...
foreach (_config debug release)
  ...
  foreach (other_file IN LISTS other_files)
    if (EXISTS "${CURRENT_PACKAGES_DIR}/${path_suffix}bin/${other_file}")
      ...
      file(RENAME "${CURRENT_PACKAGES_DIR}/${path_suffix}bin/${other_file}"
           "${target_file}"
      )
...
string(
  REGEX
  REPLACE "set\\\(__qt_initially_configured_toolchain_file [^\\\n]+\\\n"
          ""
          toolchain_contents
          "${toolchain_contents}"
)
string(
  REGEX
  REPLACE "set\\\(__qt_chainload_toolchain_file [^\\\n]+\\\n"
...
string(
  REGEX
  REPLACE "set\\\(VCPKG_CHAINLOAD_TOOLCHAIN_FILE [^\\\n]+\\\n"
          ""
          toolchain_contents
          "${toolchain_contents}"
)
string(
  REGEX
  REPLACE "set\\\(__qt_initial_c_compiler [^\\\n]+\\\n"
          ""
          toolchain_contents
          "${toolchain_contents}"
)
string(
  REGEX
  REPLACE "set\\\(__qt_initial_cxx_compiler [^\\\n]+\\\n"
          ""
          toolchain_contents
          "${toolchain_contents}"
)
string(
  REPLACE "${CURRENT_HOST_INSTALLED_DIR}"
          "\${vcpkg_installed_dir}/${HOST_TRIPLET}"
          toolchain_contents
          "${toolchain_contents}"
)
...
if (VCPKG_LIBRARY_LINKAGE STREQUAL "static" OR NOT VCPKG_TARGET_IS_WINDOWS)
  if (VCPKG_CROSSCOMPILING)
    file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/bin/qmake"
         "${CURRENT_PACKAGES_DIR}/debug/bin/qmake"
    ) # qmake has been moved so this is the qmake helper script
  endif ()
...
if (EXISTS "${target_qt_conf}")
  ...
  string(
    REGEX
    REPLACE "HostData=[^\n]+"
            "HostData=./../${TARGET_TRIPLET}/share/Qt6"
            qt_conf_contents
            ${qt_conf_contents}
  )
  string(
  ...
  if (NOT VCPKG_BUILD_TYPE)
    ...
    string(
      REGEX
      REPLACE "=(bin|lib|Qt6/plugins|Qt6/qml)"
              "=debug/\\1"
              qt_conf_contents
              ${qt_conf_contents}
    )
    ...
    configure_file(
      "${CURRENT_PACKAGES_DIR}/tools/Qt6/bin/qmake${script_suffix}"
      "${CURRENT_PACKAGES_DIR}/tools/Qt6/bin/qmake.debug${script_suffix}" COPYONLY
    )
    vcpkg_replace_string(
      "${CURRENT_PACKAGES_DIR}/tools/Qt6/bin/qmake.debug${script_suffix}"
      "target_qt.conf" "target_qt_debug.conf"
    )
  endif ()
endif ()
...
if (VCPKG_TARGET_IS_EMSCRIPTEN)
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/share/Qt6Core/Qt6WasmMacros.cmake"
...
string(
  REPLACE [[set(QT6_HOST_INFO_LIBEXECDIR "bin")]]
          [[set(QT6_HOST_INFO_LIBEXECDIR "tools/Qt6/bin")]]
          _contents
          "${_contents}"
)
string(
  REPLACE [[set(QT6_HOST_INFO_BINDIR "bin")]]
...
# MANUAL FIX - see https://github.com/microsoft/vcpkg/issues/44792
if (NOT VCPKG_CROSSCOMPILING
    OR EXISTS
       "${CURRENT_PACKAGES_DIR}/share/Qt6CoreTools/Qt6CoreToolsAdditionalTargetInfo.cmake"
)
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/share/Qt6CoreTools/Qt6CoreToolsAdditionalTargetInfo.cmake"
...
set(configfile
    "${CURRENT_PACKAGES_DIR}/share/Qt6CoreTools/Qt6CoreToolsTargets-debug.cmake"
)
if (EXISTS "${configfile}")
  file(READ "${configfile}" _contents)
  if (EXISTS "${CURRENT_PACKAGES_DIR}/tools/Qt6/bin/qmake.exe")
    file(INSTALL "${CMAKE_CURRENT_LIST_DIR}/qmake.debug.bat"
         DESTINATION "${CURRENT_PACKAGES_DIR}/tools/Qt6/bin"
    )
    string(
      REPLACE [[ "${_IMPORT_PREFIX}/tools/Qt6/bin/qmake.exe"]]
              [[ "${_IMPORT_PREFIX}/tools/Qt6/bin/qmake.debug.bat"]]
              _contents
              "${_contents}"
    )
  endif ()
  if (EXISTS "${CURRENT_PACKAGES_DIR}/tools/Qt6/bin/qtpaths.exe")
    file(INSTALL "${CMAKE_CURRENT_LIST_DIR}/qtpaths.debug.bat"
         DESTINATION "${CURRENT_PACKAGES_DIR}/tools/Qt6/bin"
    )
    string(
      REPLACE [[ "${_IMPORT_PREFIX}/tools/Qt6/bin/qtpaths.exe"]]
              [[ "${_IMPORT_PREFIX}/tools/Qt6/bin/qtpaths.debug.bat"]]
              _contents
              "${_contents}"
    )
  endif ()
  if (EXISTS "${CURRENT_PACKAGES_DIR}/tools/Qt6/bin/windeployqt.exe")
    file(INSTALL "${CMAKE_CURRENT_LIST_DIR}/windeployqt.debug.bat"
         DESTINATION "${CURRENT_PACKAGES_DIR}/tools/Qt6/bin"
    )
    string(
      REPLACE [[ "${_IMPORT_PREFIX}/tools/Qt6/bin/windeployqt.exe"]]
              [[ "${_IMPORT_PREFIX}/tools/Qt6/bin/windeployqt.debug.bat"]]
              _contents
              "${_contents}"
    )
  endif ()
...
if (VCPKG_CROSSCOMPILING)
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/share/Qt6/Qt6Dependencies.cmake"
    "${CURRENT_HOST_INSTALLED_DIR}" "\${CMAKE_CURRENT_LIST_DIR}/../../../${HOST_TRIPLET}"
  )
endif ()
...
if (VCPKG_TARGET_IS_WINDOWS)
  # dlls owned but not automatically installed by qtbase this is required to avoid
  # ownership troubles in downstream qt modules
  ...
  foreach (dll IN LISTS qtbase_owned_dlls)
    if (NOT EXISTS "${dll}") # Need to remove non-existant dlls since dependencies could
                             # have been build statically
