...
if [ ! -f "$DIR/../qgsquick/from_qgis/qgsquickutils.cpp" ]; then
  echo "Missing $DIR/qgsquick/from_qgis/qgsquickutils.cpp!"
  exit 1;
fi
...
QUICKQUI_DIR=`realpath --relative-to=$I18N_DIR $DIR/../qgsquick/from_qgis`
INPUT_DIR=../
