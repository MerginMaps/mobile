...
#ifndef MAPCANVASMAP_H
#define MAPCANVASMAP_H
 ...
 * \since QGIS 3.2
 */
class  MapCanvasMap : public QQuickItem
{
    Q_OBJECT
  ...
  public:
    ...
    MapCanvasMap( QQuickItem *parent = nullptr );
    ~MapCanvasMap() = default;
