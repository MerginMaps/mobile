...
class MMStyle: public QObject
{
  ...
  public:
    ...
    static QUrl bluetoothIcon() {return QUrl( "qrc:/Bluetooth.svg" );}
    ...
    static QUrl networkIcon() {return QUrl( "qrc:/Network.svg" );}
    ...
    static QUrl externalBluetoothGreenImage() {return QUrl( "qrc:/images/ExternalBluetoothProvider.svg" );}
    static QUrl externalNetworkGreenImage() {return QUrl( "qrc:/images/ExternalNetworkProvider.svg" );}
