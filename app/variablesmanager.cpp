...
void VariablesManager::setProjectVariables()
{
  ...
  if ( metadata.isValid() )
  {
    ...
    QgsExpressionContextUtils::setProjectVariable( mCurrentProject, QStringLiteral( "mergin_project_full_name" ),  mMerginApi->getFullProjectName( metadata.workspaceName,  metadata.name ) );
    ...
    QgsExpressionContextUtils::setProjectVariable( mCurrentProject, QStringLiteral( "mm_project_full_name" ),  mMerginApi->getFullProjectName( metadata.workspaceName,  metadata.name ) );
  }
  else
  {
    removeMerginProjectVariables( mCurrentProject );
