...
#if (defined ANDROID && QT_VERSION == QT_VERSION_CHECK(6, 5, 0) ) // due to crazy values onphysicalDotsPerInch[XY] in Qt6.5.0 (https://bugreports.qt.io/browse/QTBUG-113751)
    return realDpi / 8.;
#else
    return realDpi / 160.;
#endif
