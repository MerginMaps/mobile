...
QtObject {
    ...
    property real fontPixelSizeSmall: Utils.dp * 20 * rado2Lutra
    property real fontPixelSizeNormal: Utils.dp * 24 * rado2Lutra
    property real fontPixelSizeTitle: Utils.dp * 28 * rado2Lutra
    ...
    property real panelSpacing: Utils.dp * 5
    property real shadowVerticalOffset: -2 * Utils.dp
    property real shadowRadius: 8 * Utils.dp
    property real shadowSamples: 12
    property real panelOpacity: 1
    property real lowHighlightOpacity: 0.4
    property real highHighlightOpacity: 0.8
    property real cornerRadius: 8 * Utils.dp
    property real innerFieldMargin: 10 * Utils.dp  // TODO rename fieldMargin
    property real outerFieldMargin: 20 * Utils.dp  // TODO change for PanelMargin
    property real formSpacing: 10 * Utils.dp
