  ...
  QtObject {
    ...
    property var imageCaptured: function imageCaptured(absoluteImagePath) {
      if (absoluteImagePath) {
        var prefixPath = externalResourceHandler.itemWidget.targetDir.endsWith("/") ? externalResourceHandler.itemWidget.targetDir : externalResourceHandler.itemWidget.targetDir + "/";
