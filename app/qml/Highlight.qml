...
Item {
  ...
  property real lineWidth: 2 * QgsQuick.QgsQuick.QgsQuick.Utils.dp

  // color for polygon geometries
  property color fillColor: "red"

  // width for outlines of lines and polygons
  property real outlinePenWidth: 1 * QgsQuick.QgsQuick.QgsQuick.Utils.dp
  ...
  property real markerWidth: 30 * QgsQuick.QgsQuick.QgsQuick.Utils.dp
  property real markerHeight: 30 * QgsQuick.QgsQuick.QgsQuick.Utils.dp
  ...
  //
  property real markerOffsetY: 14 * QgsQuick.QgsQuick.QgsQuick.Utils.dp // for circle marker type to be aligned with crosshair
