...
if(APPLE)
    set(QGIS_DEFAULT_INCLUDE_PATH "${INPUT_SDK_PATH}/QGIS.app/Contents/Frameworks/qgis_core.framework/Headers")
...
foreach(provider ${QGIS_PROVIDERS_LIST})
    find_library(QGIS_${provider}_LIBRARY 
      NAMES ${provider}_a
...
find_package_handle_standard_args(
  QGIS
  REQUIRED_VARS ${QGIS_REQUIRED_VARS}
)

if(QGIS_FOUND AND NOT TARGET QGIS::Core)
  add_library(QGIS::Core STATIC IMPORTED)
  ...
  foreach(provider ${QGIS_PROVIDERS_LIST})
    ...
    set_target_properties(QGIS::${provider} PROPERTIES
      IMPORTED_LOCATION "QGIS_${provider}_LIBRARY "
    )
  endforeach()
