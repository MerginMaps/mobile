...
find_package_handle_standard_args(
  AppleFrameworks
  REQUIRED_VARS ${APPLE_REQUIRED_VARS}
)
...
if(AppleFrameworks_FOUND AND NOT TARGET AppleFrameworks::CoreFoundation)
  foreach(framework ${APPLE_FRAMEWORKS})
      ...
      set_target_properties(AppleFrameworks::${framework} PROPERTIES
        INTERFACE_LINK_LIBRARIES "-framework ${framework}"
      )
  endforeach()
endif()
