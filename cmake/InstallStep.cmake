...
if(WIN)
	...
	# Libraries
	install(DIRECTORY ${INPUT_SDK_PATH_MULTI}/bin/ DESTINATION . FILES_MATCHING PATTERN "*.dll" PATTERN "Qca" EXCLUDE )
	install(DIRECTORY ${INPUT_SDK_PATH_MULTI}/bin/Qca/crypto/ DESTINATION . FILES_MATCHING PATTERN "*.dll")
	install(DIRECTORY ${INPUT_SDK_PATH_MULTI}/tools/qgis/plugins/ DESTINATION . FILES_MATCHING PATTERN "*.dll")
	
	# Qt
	set(qml_dirs Qt Qt5Compat QtMultimedia QtQml QtQuick QtPositioning QtCore QtSensors)
	foreach (qml_dir ${qml_dirs})
	  install(DIRECTORY ${Qt6_base_dir}/qml/${qml_dir} DESTINATION qml PATTERN "*d.dll" EXCLUDE)
	endforeach()
	
	set(plugins_dirs position sqldrivers imageformats platforms multimedia)
	foreach (plugins_dir ${plugins_dirs})
	  install(DIRECTORY ${Qt6_base_dir}/plugins/${plugins_dir} DESTINATION . PATTERN "*d.dll" EXCLUDE)
	endforeach()
	...
	# Translations
	install(DIRECTORY app/i18n/ DESTINATION translations FILES_MATCHING PATTERN "*.qm" )	
