...
class MerginApi: public QObject
{
  ...
  public:
    ...
    /**
    * Currently no auth service is used, only "username:password" is encoded and assigned to mToken.
    * \param login Login username to Mergin Maps - either username or registered email
    * \param password Password to given username to log in to Mergin Maps
    */
