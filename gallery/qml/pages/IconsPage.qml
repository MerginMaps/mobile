      ...
      Column {
        ...
        GroupBox {
          ...
          Column {
            ...
            IconLine { name: "featuresIcon"; source: __style.featuresIcon; showRect: checkboxBorder.checked; invertColors: checkboxColor.checked }
            IconLine { name: "featuresFilledIcon"; source: __style.featuresFilledIcon; showRect: checkboxBorder.checked; invertColors: checkboxColor.checked }
            IconLine { name: "infoIcon"; source: __style.infoIcon; showRect: checkboxBorder.checked; invertColors: checkboxColor.checked }
            IconLine { name: "infoFilledIcon"; source: __style.infoFilledIcon; showRect: checkboxBorder.checked; invertColors: checkboxColor.checked }
          }
        }
      }
