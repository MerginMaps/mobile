...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpressionEnabled="0" name="General" visibilityExpression="" showLabel="1" columnCount="1" groupBox="0">
      <attributeEditorField name="Heading" index="1" showLabel="1"/>
      <attributeEditorField name="Importance" index="2" showLabel="1"/>
    </attributeEditorContainer>
    <attributeEditorContainer visibilityExpressionEnabled="0" name="People" visibilityExpression="" showLabel="1" columnCount="1" groupBox="0">
